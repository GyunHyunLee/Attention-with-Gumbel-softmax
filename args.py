...
def get_parser():
    ...
    parser.add_argument('--step', type=int, default=[90, 100, 120], nargs='+', help='the epoch where optimizer reduce the learning rate')
    ...
    parser.add_argument('--num_epoch', type=int, default=150, help='stop training in which epoch')
