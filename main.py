...
class Processor():
    ...
    def __init__(self, arg):
        ...
        if self.arg.phase == 'model_size':
            ...
            self.load_optimizer()
            self.scheduler = optim.lr_scheduler.CosineAnnealingLR(self.optimizer, T_max=50, eta_min=0)
            self.load_data()
        self.best_acc = 0
    ...
    def start(self):
        if self.arg.phase == 'train':
            ...
            for epoch in range(self.arg.start_epoch, self.arg.num_epoch):
                ...
                # if epoch > 80:
                val_loss = self.eval(epoch, save_score=self.arg.save_score, loader_name=['test'])
