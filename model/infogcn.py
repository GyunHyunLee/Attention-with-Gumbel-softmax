...
class InfoGCN(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, graph=None, in_channels=3,
        ...
        self.l1 = EncodingBlock(base_channel, base_frames, base_channel,A)
        self.l2 = EncodingBlock(base_channel, base_frames, base_channel,A)
        self.l3 = EncodingBlock(base_channel, base_frames, base_channel,A)
        self.l4 = EncodingBlock(base_channel, base_frames/2, base_channel*2, A, stride=2)
        self.l5 = EncodingBlock(base_channel*2, base_frames/2, base_channel*2, A)
        self.l6 = EncodingBlock(base_channel*2, base_frames/2, base_channel*2, A)
        self.l7 = EncodingBlock(base_channel*2, base_frames/4, base_channel*4, A, stride=2)
        self.l8 = EncodingBlock(base_channel*4, base_frames/4, base_channel*4, A)
        self.l9 = EncodingBlock(base_channel*4, base_frames/4, base_channel*4, A)
    ...
    def get_A(self, graph, k):
        ...
        I = np.eye(Graph.num_node).astype(np.float32)
